                        ...
                        <div class="text-center mt-4">
                            <div class="mb-3">
                                <a href="{{ url('/') }}" class="auth-logo">
                                    <img src="{{ asset('backend/assets/images/logo.jpg') }}" class="logo-dark mx-auto" alt="" width="200px">
                                    <img src="{{ asset('backend/assets/images/logo.jpg') }}" class="logo-light mx-auto" alt="" width="200px">
                                </a>
                            </div>
                        </div>
