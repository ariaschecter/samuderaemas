            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ $gambar->kegiatan_id ? route('admin.kegiatan.show', $gambar->kegiatan_id) : route('admin.wisata.show', $gambar->wisata_id) }}">{{ $gambar->kegiatan_id ? $gambar->kegiatan->judul_kegiatan :  $gambar->wisata->judul_wisata }}</a></li>
