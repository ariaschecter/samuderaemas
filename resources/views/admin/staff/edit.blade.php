              ...
              <div class="card-body">
                ...
                <form method="post" action="{{ route('admin.staff.update', $staff->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input name="nama_staff" class="form-control" type="text" value="{{ $staff->nama_staff }}" id="nama_staff">
                            @error('nama_staff')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input name="jabatan_staff" class="form-control" type="text" value="{{ $staff->jabatan_staff }}" id="jabatan_staff">
                            @error('jabatan_staff')
                                <span class="text-danger"> {{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input name="motivasi_staff" class="form-control" type="text" value="{{ $staff->motivasi_staff }}" id="motivasi_staff">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea name="bio_staff" id="elm1" cols="30" rows="10">{{ $staff->bio_staff }}</textarea>
                            @error('bio_staff')
                                <span class="text-danger"> {{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <img id="showImage" class="img-fluid img-thumbnail" src="{{ asset('storage/' . $staff->gambar_staff) }}" alt="Image Show">
                        </div>
                    </div>
                    <!-- end row -->


                    <input type="submit" class="btn btn-info waves-effect waves-light" value="Update Staff Data">
                  </form>
